 ...
 *
 * Decouples lifecycle-event correlation from any particular storage strategy —
 * an in-memory map, an LRU cache, or a persistent store may be injected
 * without touching [MoEngagePlugin] or [MoEngageEventDispatcher].
 *
